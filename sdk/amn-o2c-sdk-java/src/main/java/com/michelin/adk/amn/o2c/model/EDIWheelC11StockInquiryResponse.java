...
import com.michelin.adk.amn.o2c.model.EDIWheelC11StockInquiryResponseBuyerParty;
...
public class EDIWheelC11StockInquiryResponse {
  ...
  @javax.annotation.Nullable
  private EDIWheelC11StockInquiryResponseBuyerParty buyerParty;
  ...
  public EDIWheelC11StockInquiryResponse buyerParty(@javax.annotation.Nullable EDIWheelC11StockInquiryResponseBuyerParty buyerParty) {
   ...
   */
  @javax.annotation.Nullable
  public EDIWheelC11StockInquiryResponseBuyerParty getBuyerParty() {
    return buyerParty;
  }

  public void setBuyerParty(@javax.annotation.Nullable EDIWheelC11StockInquiryResponseBuyerParty buyerParty) {
    this.buyerParty = buyerParty;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(documentID, variant, errorHead, buyerParty, consignee, orderLine);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("buyerParty") != null && !jsonObj.get("buyerParty").isJsonNull()) {
        EDIWheelC11StockInquiryResponseBuyerParty.validateJsonElement(jsonObj.get("buyerParty"));
      }
