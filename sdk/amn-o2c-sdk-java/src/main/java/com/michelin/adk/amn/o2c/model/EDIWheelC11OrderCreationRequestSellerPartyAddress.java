...
public class EDIWheelC11OrderCreationRequestSellerPartyAddress {
  ...
  public EDIWheelC11OrderCreationRequestSellerPartyAddress street(List<String> street) {
    this.street = street;
    return this;
  }
  ...
  public EDIWheelC11OrderCreationRequestSellerPartyAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  public EDIWheelC11OrderCreationRequestSellerPartyAddress district(String district) {
  ...
  public EDIWheelC11OrderCreationRequestSellerPartyAddress postCode(String postCode) {
  ...
  public EDIWheelC11OrderCreationRequestSellerPartyAddress postBoxCode(String postBoxCode) {
  ...
  public EDIWheelC11OrderCreationRequestSellerPartyAddress subCountry(String subCountry) {
  ...
  public EDIWheelC11OrderCreationRequestSellerPartyAddress countryCode(String countryCode) {
