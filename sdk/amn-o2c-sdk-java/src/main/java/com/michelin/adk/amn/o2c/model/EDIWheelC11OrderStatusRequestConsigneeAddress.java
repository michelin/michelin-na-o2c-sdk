...
public class EDIWheelC11OrderStatusRequestConsigneeAddress {
  ...
  public boolean equals(Object o) {
    ...
    EDIWheelC11OrderStatusRequestConsigneeAddress edIWheelC11OrderStatusRequestConsigneeAddress = (EDIWheelC11OrderStatusRequestConsigneeAddress) o;
    return Objects.equals(this.street, edIWheelC11OrderStatusRequestConsigneeAddress.street) &&
        Objects.equals(this.city, edIWheelC11OrderStatusRequestConsigneeAddress.city) &&
        Objects.equals(this.district, edIWheelC11OrderStatusRequestConsigneeAddress.district) &&
        Objects.equals(this.postCode, edIWheelC11OrderStatusRequestConsigneeAddress.postCode) &&
        Objects.equals(this.postBoxCode, edIWheelC11OrderStatusRequestConsigneeAddress.postBoxCode) &&
        Objects.equals(this.subCountry, edIWheelC11OrderStatusRequestConsigneeAddress.subCountry) &&
        Objects.equals(this.countryCode, edIWheelC11OrderStatusRequestConsigneeAddress.countryCode) &&
        Objects.equals(this.geolocation, edIWheelC11OrderStatusRequestConsigneeAddress.geolocation);
  }
  ...
  public String toString() {
    ...
    sb.append("class EDIWheelC11OrderStatusRequestConsigneeAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EDIWheelC11OrderStatusRequestConsigneeAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EDIWheelC11OrderStatusRequestConsigneeAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EDIWheelC11OrderStatusRequestConsigneeAddress is not found in the empty JSON string", EDIWheelC11OrderStatusRequestConsigneeAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EDIWheelC11OrderStatusRequestConsigneeAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EDIWheelC11OrderStatusRequestConsigneeAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EDIWheelC11OrderStatusRequestConsigneeAddress.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EDIWheelC11OrderStatusRequestConsigneeAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EDIWheelC11OrderStatusRequestConsigneeAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EDIWheelC11OrderStatusRequestConsigneeAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EDIWheelC11OrderStatusRequestConsigneeAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<EDIWheelC11OrderStatusRequestConsigneeAddress>() {
           @Override
           public void write(JsonWriter out, EDIWheelC11OrderStatusRequestConsigneeAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EDIWheelC11OrderStatusRequestConsigneeAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EDIWheelC11OrderStatusRequestConsigneeAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EDIWheelC11OrderStatusRequestConsigneeAddress
   * @throws IOException if the JSON string is invalid with respect to EDIWheelC11OrderStatusRequestConsigneeAddress
   */
  public static EDIWheelC11OrderStatusRequestConsigneeAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EDIWheelC11OrderStatusRequestConsigneeAddress.class);
  }

  /**
   * Convert an instance of EDIWheelC11OrderStatusRequestConsigneeAddress to an JSON string
   *
   * @return JSON string
   */
