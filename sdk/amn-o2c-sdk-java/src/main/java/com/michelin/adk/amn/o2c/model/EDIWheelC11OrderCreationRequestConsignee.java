...
public class EDIWheelC11OrderCreationRequestConsignee {
  ...
  public EDIWheelC11OrderCreationRequestConsignee partyID(String partyID) {
  ...
  public EDIWheelC11OrderCreationRequestConsignee agencyCode(String agencyCode) {
  ...
  public EDIWheelC11OrderCreationRequestConsignee name(List<String> name) {
    this.name = name;
    return this;
  }
  ...
  public EDIWheelC11OrderCreationRequestConsignee address(EDIWheelC11OrderCreationRequestConsigneeAddress address) {
  ...
  public EDIWheelC11OrderCreationRequestConsignee informationContact(EDIWheelC11OrderCreationRequestSellerPartyInformationContact informationContact) {
