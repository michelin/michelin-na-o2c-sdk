...
public class EDIWheelC11StockInquiryResponseOrderLineInnerOrderedArticleScheduleDetailsInner {
  ...
  /**
   * Expected delivery date if order placed by OrderByDate/OrderByTime.
   * @return deliveryDate
   */
  @javax.annotation.Nullable
  ...
  /**
   * To receive the product by the expected delivery date, the order must be placed by this date.
   * @return orderByDate
   */
  @javax.annotation.Nullable
  ...
  /**
   * To receive the product by the expected delivery date, the order must be placed by this time on the indicated date.
   * @return orderByTime
   */
  @javax.annotation.Nullable
  ...
  /**
   * Transport priority (e.g., REPL for Next Truck shipment).
  ...
  /**
   * Indicator if the product is available for pickup from the supplier.
   * @return pickUp
   */
  @javax.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deliveryDate, deliveryTime, orderByDate, orderByTime, transportPriority, pickUp, availableQuantity, priceDetails, charge, supplierParty);
  }
