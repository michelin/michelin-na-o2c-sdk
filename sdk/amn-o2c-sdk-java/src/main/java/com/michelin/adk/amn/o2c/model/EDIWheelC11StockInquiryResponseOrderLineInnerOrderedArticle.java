...
public class EDIWheelC11StockInquiryResponseOrderLineInnerOrderedArticle {
  ...
  public EDIWheelC11StockInquiryResponseOrderLineInnerOrderedArticle articleDescription(@javax.annotation.Nullable EDIWheelC11OrderCreationResponseOrderLineInnerOrderedArticleArticleDescription articleDescription) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(articleIdentification, articleDescription, availability, requestedQuantity, error, scheduleDetails);
  }
