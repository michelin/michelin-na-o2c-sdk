...
public class EDIWheelC11OrderCreationRequestSellerPartyInformationContact {
  ...
  public EDIWheelC11OrderCreationRequestSellerPartyInformationContact addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public boolean equals(Object o) {
    ...
    EDIWheelC11OrderCreationRequestSellerPartyInformationContact edIWheelC11OrderCreationRequestSellerPartyInformationContact = (EDIWheelC11OrderCreationRequestSellerPartyInformationContact) o;
    return Objects.equals(this.contactID, edIWheelC11OrderCreationRequestSellerPartyInformationContact.contactID) &&
        Objects.equals(this.name, edIWheelC11OrderCreationRequestSellerPartyInformationContact.name) &&
        Objects.equals(this.telephoneNumber, edIWheelC11OrderCreationRequestSellerPartyInformationContact.telephoneNumber) &&
        Objects.equals(this.telephoneExtension, edIWheelC11OrderCreationRequestSellerPartyInformationContact.telephoneExtension) &&
        Objects.equals(this.faxNumber, edIWheelC11OrderCreationRequestSellerPartyInformationContact.faxNumber) &&
        Objects.equals(this.emailAddress, edIWheelC11OrderCreationRequestSellerPartyInformationContact.emailAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class EDIWheelC11OrderCreationRequestSellerPartyInformationContact {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EDIWheelC11OrderCreationRequestSellerPartyInformationContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EDIWheelC11OrderCreationRequestSellerPartyInformationContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EDIWheelC11OrderCreationRequestSellerPartyInformationContact is not found in the empty JSON string", EDIWheelC11OrderCreationRequestSellerPartyInformationContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EDIWheelC11OrderCreationRequestSellerPartyInformationContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EDIWheelC11OrderCreationRequestSellerPartyInformationContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EDIWheelC11OrderCreationRequestSellerPartyInformationContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EDIWheelC11OrderCreationRequestSellerPartyInformationContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EDIWheelC11OrderCreationRequestSellerPartyInformationContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EDIWheelC11OrderCreationRequestSellerPartyInformationContact.class));

       return (TypeAdapter<T>) new TypeAdapter<EDIWheelC11OrderCreationRequestSellerPartyInformationContact>() {
           @Override
           public void write(JsonWriter out, EDIWheelC11OrderCreationRequestSellerPartyInformationContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EDIWheelC11OrderCreationRequestSellerPartyInformationContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EDIWheelC11OrderCreationRequestSellerPartyInformationContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EDIWheelC11OrderCreationRequestSellerPartyInformationContact
   * @throws IOException if the JSON string is invalid with respect to EDIWheelC11OrderCreationRequestSellerPartyInformationContact
   */
  public static EDIWheelC11OrderCreationRequestSellerPartyInformationContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EDIWheelC11OrderCreationRequestSellerPartyInformationContact.class);
  }

  /**
   * Convert an instance of EDIWheelC11OrderCreationRequestSellerPartyInformationContact to an JSON string
   *
   * @return JSON string
   */
