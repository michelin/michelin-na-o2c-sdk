...
import com.michelin.adk.amn.auth.Authentication;
import com.michelin.adk.amn.auth.HttpBasicAuth;
import com.michelin.adk.amn.auth.HttpBearerAuth;
import com.michelin.adk.amn.auth.ApiKeyAuth;
import com.michelin.adk.amn.auth.OAuth;
import com.michelin.adk.amn.auth.RetryingOAuth;
import com.michelin.adk.amn.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://indus.api.michelin.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://indus.api.michelin.com",
      "Test server",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.michelin.com",
      "Production server",
      new HashMap<String, ServerVariable>()
    )
  ));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "/idp/v2/b2b/oauth2/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.0.0-SNAPSHOT/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://indus.api.michelin.com
     ...
     * @return a {@link com.michelin.adk.amn.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.michelin.adk.amn.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.michelin.adk.amn.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.michelin.adk.amn.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.michelin.adk.amn.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.michelin.adk.amn.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.michelin.adk.amn.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.michelin.adk.amn.ApiException If fails to update the parameters
     */
     ...
     * @throws com.michelin.adk.amn.ApiException If fail to serialize the request body object into a string
     */
